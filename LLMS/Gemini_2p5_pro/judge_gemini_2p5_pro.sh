#!/usr/bin/env bash
# Usage:
#   bash judge_gemini_2p5_pro.sh [CUDA_VISIBLE_DEVICES]
#
# Examples:
#   bash judge_gemini_2p5_pro.sh 0
#   bash judge_gemini_2p5_pro.sh 0,1
#   CUDA_VISIBLE_DEVICES=2 bash judge_gemini_2p5_pro.sh
#
...
INPUT_FILE="$SCRIPT_DIR/loong_gemini_2p5_pro_99_results.jsonl"
